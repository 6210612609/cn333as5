...
import com.example.contact.ui.components.ContactColor
import com.example.contact.util.fromHex
...
private fun SaveContactContent(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        val isChecked: Boolean = contact.isRecent
        ...
        FavoriteCheckOption(
            ...
            onCheckedChange = { FavoriteNewValue ->
                ...
                onContactChange.invoke(contact.copy(isRecent = isCheckedOff))
            }
        )
        ContentTextField(
            label = "Name",
...
private fun FavoriteCheckOption(
    ...
    Row(
        ...
        Text(
            text = "Is this Contact added to recent?",
...
private fun ContactCheckOption(
    ...
    Row(
        ...
        Text(
            text = "Can this contact be selected?",
            modifier = Modifier.weight(1f)
        )
        Switch(
            checked = isChecked,
